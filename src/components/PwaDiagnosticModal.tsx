      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        ...
        >
          ...
          <div className="space-y-4 text-xs text-slate-300">
            ...
            {/* Explanation of Page Not Found and GitHub */}
            <div className="p-3.5 bg-red-950/30 border border-red-500/30 rounded-2xl space-y-2">
              <h4 className="font-bold text-red-200 text-xs flex items-center space-x-2">
                <ShieldAlert className="w-4 h-4 text-red-400 shrink-0" />
                <span>Dlaczego pojawił się komunikat "Error: Page not found"?</span>
              </h4>
              <p className="text-slate-300 leading-relaxed text-[11px]">
                Komunikat <em>"The requested URL was not found on this server"</em> pochodzi bezpośrednio z serwera kontenera Cloud Run. Występuje, gdy otwarto nieaktywny adres podglądu deweloperskiego lub gdy sesja robocza została zrestartowana.
              </p>
              <div className="p-2.5 bg-red-900/20 rounded-xl border border-red-500/20 text-[11px] text-red-100">
                👉 <strong>Czy trzeba dodawać apkę na GitHub?</strong><br />
                <strong>Nie! GitHub NIE jest wymagany do działania ani instalacji PWA.</strong> Aplikacja jest już uruchomiona i serwowana na żywo na serwerze Cloud Run. GitHub służy tylko do przechowywania kodu źródłowego.
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="font-bold text-slate-100 text-sm flex items-center space-x-2">
                ...
                <span>3 Przyczyny różnic w odczytach Lux i jak działa przełącznik:</span>
              </h4>

              <div className="p-3 bg-slate-800/50 border border-slate-700/50 rounded-xl space-y-1">
                <p className="font-bold text-amber-300">1. Dlaczego przełącznik Wewnątrz / Zewnątrz przelicza wartości?</p>
                <p className="text-slate-300 leading-relaxed text-[11px]">
              ...
              <div className="p-3 bg-slate-800/50 border border-slate-700/50 rounded-xl space-y-1">
                <p className="font-bold text-cyan-300">2. Jaki aparat jest wykorzystywany?</p>
                <p className="text-slate-300 leading-relaxed text-[11px]">
                  Domyślnie funkcja wymusza <strong>Tylny aparat główny (Environment Camera)</strong>, skierowany w niebo. Jeśli masz podłączony aparat selfie lub laptop, możesz kliknąć <em>"Przełącz aparat"</em> powyżej.
                </p>
              </div>

              <div className="p-3 bg-slate-800/50 border border-slate-700/50 rounded-xl space-y-1">
                <p className="font-bold text-purple-300">3. Instalacja PWA na telefonie</p>
                <p className="text-slate-300 leading-relaxed text-[11px]">
                  Kliknij menu z 3 kropkami w przeglądarce Chrome na telefonie i wybierz <strong>"Dodaj do ekranu głównego" / "Zainstaluj aplikację"</strong>. Dzięki temu ikona pojawi się wśród Twoich aplikacji na pulpicie telefonu!
                </p>
              </div>
            </div>
          </div>
