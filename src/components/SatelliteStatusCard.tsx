  ...
  const satellites = [
    {
      ...
      provides: "Precyzyjny pomiar wilgotności gleby pod korzeniami (0-3 cm)",
      status: "ONLINE",
      frequency: "Co 12-24 godz. (Skan mikrofalowy)",
      liveMetric: `Wilgotność gleby: ${soilMoistureSat}%`,
      iconBg: "bg-emerald-500/20 text-emerald-300 border-emerald-500/40",
      description: "Przebija się przez chmury i ciemność nocy, wysyłając wiązkę radarową, która odbija się od cząsteczek wody w glebie w Twojej okolicy."
    },
    {
      id: "meteosat",
      ...
      status: "ONLINE",
      frequency: "Skany co 10 minut w czasie rzeczywistym",
